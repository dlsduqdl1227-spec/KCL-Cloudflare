...
function liveAuditCleanSqls_() {
  return [
    [`DELETE FROM scores WHERE judge_name LIKE '__AI_TEST_%' OR participant_name LIKE '__AI_TEST_%' OR unit LIKE 'AI62-%' OR payload_json LIKE '%__AI_TEST_%'`],
    [`DELETE FROM participants WHERE name LIKE '__AI_TEST_%' OR team_name LIKE '__AI_TEST_%' OR unique_no LIKE 'AI62-%' OR cup_no LIKE 'AI62-%' OR sample_no LIKE 'AI62-%' OR team_no LIKE 'AI62-%' OR prelim_cup_no LIKE 'AI62-%' OR main_cup_no LIKE 'AI62-%' OR final_cup_no LIKE 'AI62-%' OR extra_json LIKE '%__AI_TEST_%'`],
    [`DELETE FROM operators WHERE name LIKE '__AI_TEST_%' OR phone LIKE '0196262%'`],
    [`DELETE FROM sessions WHERE token LIKE 'AI62-%' OR kind LIKE 'LIVE_AUDIT_%' OR payload_json LIKE '%__AI_TEST_%'`]
  ];
}
