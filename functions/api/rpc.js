...
function generateCuppingComment(payload) {
  ...
  return _optionSet([
    `${prefix}${processText}${flavor} 인상이 먼저 열리고, 후반부에는 ${after} 흐름이 이어집니다. 산미는 ${acidity} 방향으로 컵의 구조를 만들고, 바디는 ${body} 질감을 보태며, 단맛은 ${sweet} 인상으로 균형을 받쳐줍니다. 전체적으로 ${tone} 컵으로 보이며, ${strength}`,
